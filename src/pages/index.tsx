...
const IndexPage = () => {
  ...
  return (
    <div className="min-h-screen pt-24 py-20 bg-gradient-to-b from-avgx-primary to-avgx-secondary dark:from-avgx-primary dark:to-avgx-secondary light:from-white light:to-gray-50">
