...
const ContactPage = () => {
  ...
  return (
    <div className="min-h-screen pt-24 py-20 bg-avgx-primary dark:bg-avgx-primary light:bg-white">
              ...
              <div className="space-y-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <div className="text-avgx-text-secondary dark:text-avgx-text-secondary light:text-gray-600">contact@avgx.world</div>
                  </div>
                </div>
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <div className="text-avgx-text-secondary dark:text-avgx-text-secondary light:text-gray-600">docs.avgx.world</div>
                  </div>
                </div>
              </div>
            </GlassCard>
